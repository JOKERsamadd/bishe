package cn.net.zhipeng.security.service;

import cn.net.zhipeng.common.utils.DateUtil;
import cn.net.zhipeng.security.domain.FebsSocialUserDetails;
import cn.net.zhipeng.security.domain.FebsUserDetails;
import cn.net.zhipeng.security.domain.LoginType;
import cn.net.zhipeng.security.exception.FebsCredentialExcetion;
import cn.net.zhipeng.system.domain.MyUser;
import cn.net.zhipeng.system.service.MenuService;
import cn.net.zhipeng.system.service.UserService;
...
public class FebsUserDetailService implements UserDetailsService, SocialUserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) {
        ...
        boolean isMobile = FebsUtil.isPhoneNo(username);
        if (user != null) {
