package cn.net.zhipeng.common.utils.poi;

import cn.net.zhipeng.common.annotation.ExportConfig;
import cn.net.zhipeng.common.utils.poi.convert.ExportConvert;
import cn.net.zhipeng.common.utils.poi.pojo.ExportItem;
...
public class ExcelUtils {
    ...
    private void requiredbuilderParams() {
        if (mClass == null) {
            throw new IllegalArgumentException("请先使用cn.net.zhipeng.common.utils.poi.ExcelUtils.builder(Class<?>)构造器初始化参数。");
        }
    }
    ...
    private void requiredexportParams() {
        if (mClass == null || mResponse == null) {
            throw new IllegalArgumentException(
                    "请先使用cn.net.zhipeng.common.utils.poi.ExcelUtils.export(Class<?>, HttpServletResponse)构造器初始化参数。");
        }
