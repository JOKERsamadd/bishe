package cn.net.zhipeng.common.aspect;

import cn.net.zhipeng.common.annotation.Limit;
import cn.net.zhipeng.common.domain.LimitType;
...
public class LimitAspect {
    ...
    @Pointcut("@annotation(cn.net.zhipeng.common.annotation.Limit)")
